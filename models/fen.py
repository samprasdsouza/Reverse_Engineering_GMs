...
class DnCNN(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # thirdPart_fft_1=torch.rfft(residual_gray, signal_ndim=2, onesided=False)   #pyTorch 1.9.0 and below
        # thirdPart_fft_1 = torch.fft.fft2(residual_gray)  # Equivalent to torch.rfft with onesided=true
        thirdPart_fft_1 = torch.view_as_real(torch.fft.fft2(residual_gray))        #pyTorch 1.10.0 and above
